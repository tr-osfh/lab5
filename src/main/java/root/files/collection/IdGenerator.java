 ...
 *
 * <p>Сгенерированные ID сохраняются в статическом хранилище для проверки уникальности.</p>
 *
 * <p>Внимание: Не потокобезопасен. Для многопоточного использования требуется синхронизация.</p>
 */
